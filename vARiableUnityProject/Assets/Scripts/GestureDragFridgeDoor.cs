...
public class GestureDragFridgeDoor : MonoBehaviour {
    Vector3 deltaPos;
    ...
    void OnTapHoldAndDrag(Vector3 mouse_velocity)
    {
        ...
        //}
        if (original_ang + Vector3.Dot(mouse_move_dis, this.transform.parent.transform.right.normalized) * 500 > -135 &&
            original_ang + Vector3.Dot(mouse_move_dis, this.transform.parent.transform.right.normalized) * 500 < 0)
        {
