...
{
    GameObject interactingGameObject, interactingGameObject2;
    Vector3 moving_speed, moving_speed2;
    Vector3 touch_position, touch_position2;
    public Touch_info()
    {
        interactingGameObject = null;
        interactingGameObject2 = null;
        moving_speed = new Vector3(0, 0, 0);
        touch_position = new Vector3(0, 0, 0);
        moving_speed2 = new Vector3(0, 0, 0);
        touch_position2 = new Vector3(0, 0, 0);
    }
} //t4

public class InputStates_test4 : MonoBehaviour {
    // only in test4
    //
    //public GameObject interactingGameObject, interactingGameObject2;
    //public Vector3 moving_speed;
    //public Vector3 touch_position;

    public Touch_info touchInf; //t4
            ...
            case STATE.state_gesture_tapHoldAndDrag:
                {
                    ...
                    if (Input.GetMouseButton(0))
                    {
                        if (old_mouse_pos != mouse_pos)
                        {
                            mouse_velocity = (mouse_pos - old_mouse_pos) / Time.deltaTime;
