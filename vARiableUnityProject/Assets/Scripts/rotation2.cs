...
public class rotation2 : MonoBehaviour
{
    ...
    void Start()
    {
        //initial_rot.Set(0f, 0f, 0f, Mathf.Cos(50));
    ...
    void Update()
    {
        ...
        //rotation_axis = Vector3.Cross(Input.mousePosition - old_mouse_pos,);




        Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
        camera_front = the_camera.transform.forward;
        ...
        if (Input.GetMouseButton(0))
        {
            if (old_relative_coordinate_of_mouse != relative_coordinate_of_mouse)
            {
                ...
                angle_rotate = Mathf.Rad2Deg * Vector3.Cross(old_relative_coordinate_of_mouse.normalized, relative_coordinate_of_mouse.normalized).magnitude;
